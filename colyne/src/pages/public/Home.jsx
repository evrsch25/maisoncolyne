          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className={`order-1 lg:order-2 ${!bienvenueImage ? 'lg:col-span-3 max-w-3xl mx-auto text-center' : 'lg:col-span-2'}`}>
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
                viewport={{ once: true }}
                className={`text-3xl md:text-4xl font-display font-bold text-brown-dark mb-6 ${!bienvenueImage ? 'text-center' : ''}`}
              >
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className={`text-lg text-gray-700 leading-relaxed mb-8 ${!bienvenueImage ? 'text-center' : ''}`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-display font-semibold mb-2 text-brown-dark flex items-center gap-3">
      ...
      <section className="py-16 bg-green text-white">
        <div className="container-custom">
          ...
          >
            ...
            <footer className="text-beige-light">— Henri Cartier Besson</footer>
          </motion.blockquote>
        </div>
      </section>
